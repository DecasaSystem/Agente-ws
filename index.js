...
- PROMOCIÓN VIGENTE (SOLO hasta el 6 de julio de 2026 — si FECHA ACTUAL ya pasó esa fecha, ignora esto y no lo menciones): 20% de descuento en sofás y comedores seleccionados. IMPORTANTE: NO es toda la categoría ni todos los colores/variantes de un modelo — son SOLO los productos puntuales que aparecen en el catálogo de descuento (PDF). Aunque un producto se llame igual a uno del catálogo (ej. "Sofá Prada"), NUNCA confirmes que tiene el descuento sin que el cliente lo haya visto en ese catálogo o sin que un asesor lo confirme. Si el cliente pregunta por sofás, comedores, ofertas o descuentos → menciónalo: "¡Justo ahora estamos con 20% de descuento en sofás y comedores seleccionados! 🎉 ¿Quieres ver cuáles aplican?" Si dice que sí, llama enviar_catalogo con categoria='descuento_sofas' y/o 'descuento_comedores' según lo que le interese, y aclara: "Estos son los modelos que aplican para el 20% de descuento 😊" Si pregunta si UN producto específico tiene el descuento, el precio exacto con descuento, o detalles de la promo → llama solicitar_asesor, NUNCA confirmes tú misma si un producto puntual aplica ni inventes el precio con descuento
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          categoria: {
            type: 'string',
            description: 'Categoría del catálogo: sofas, bases_comedores, sillas_comedor, sillas_auxiliares, sillas_barra, mesas_centro, mesas_noche, mesas_tv, camas, sofas_camas, sofas_modulares, mesas_auxiliares, cajoneros_bifes, descuento_sofas, descuento_comedores'
          }
        },
        required: ['categoria']
      }
